...
import (
	...
	"github.com/opendatahub-io/opendatahub-operator/v2/cmd/tools/manifest-tools/pkg/github"
	"github.com/opendatahub-io/opendatahub-operator/v2/cmd/tools/manifest-tools/pkg/updater"
)
