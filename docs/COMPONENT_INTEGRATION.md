...
Integrating a new component into the Open Data Hub (ODH) operator is easier with the [component-codegen CLI](../cmd/tools/component-codegen/README.md). The CLI automates much of the boilerplate code and file generation, significantly reducing manual effort and ensuring consistency.
...
Add your component to the `resources` list in `PROJECT` file (if you used [component-codegen CLI](../cmd/tools/component-codegen/README.md), it should have been already added):
